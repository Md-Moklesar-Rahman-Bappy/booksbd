...
<body class="home-page home-01 ">
				...
				<div class="topbar-menu-area">
					<div class="container">
						<div class="topbar-menu left-menu">
							<ul>
								<li class="menu-item" >
									<a title="!!! প্রিয় পাঠক, সুস্বাগতম !!!" href="#" ><span></span><b>!!! প্রিয় পাঠক, সুস্বাগতম !!!</b></a>
								</li>
							</ul>
						</div>
						<div class="topbar-menu right-menu">
							<ul>
								<li class="menu-item" ><a><i class="fas fa-phone-alt"> +৮৮০-১৭১-৩১৩-৮৭০৭</i></a></li>
								<li class="menu-item" ><a><i class="fas fa-envelope-open-text">  query@booksbd.net</i></a></li>
								<li class="menu-item" ><a><i class="fas fa-map-marker-alt"> ৩৭৪/১, আহমেদ নগর, মিরপুর-১, ঢাকা-১২১৬</i></a></li>
							</ul>
						</div>
					</div>
				</div>
						...
						<div class="wrap-search center-section">
							<div class="wrap-search-form">
								<form action="#" id="form-search-top" name="form-search-top">
									<input type="text" name="search" value="" placeholder="বইয়ের নাম লিখুন...">
									<button form="form-search-top" type="button"><i class="fa fa-search" aria-hidden="true"></i></button>

									<!-- Search All Category Option Start-->
									...
									<!-- Search All Category Option End-->
					...
					<div class="primary-nav-section">
						<div class="container">
							<ul class="nav primary clone-main-menu" id="mercado_main" data-menuname="Main menu" >
								...
								<li class="menu-item">
									<a href="#" class="link-term mercado-item-title">প্রকাশনী</a>
								</li>
								<li class="menu-item">
									<a href="#" class="link-term mercado-item-title">লেখক</a>
								</li>
								<li class="menu-item">
									<a href="#" class="link-term mercado-item-title">চিল্ড্রেন্স কর্নার</a>
								</li>
								<li class="menu-item">
									<a href="#" class="link-term mercado-item-title">বইমেলা ২০২১</a>
								</li>
								<li class="menu-item">
									<a href="#" class="link-term mercado-item-title">বেস্টসেলার</a>
								</li>
								<li class="menu-item">
									<a href="#" class="link-term mercado-item-title">প্রাতিষ্ঠানিক অর্ডার</a>
								</li>	
								<li class="menu-item">
									<a href="#" class="link-term mercado-item-title">প্রি অর্ডার</a>
								</li>	
								<li class="menu-item">
									<a href="#" class="link-term mercado-item-title">বিষয়ভিত্তিক বই</a>
								</li>																		
							</ul>
						</div>
					</div>
	...
	<main id="main">
		<div class="container">
			...
			<div id="wrapper">
				<div id="left">
					<iframe width="560" height="315" src="https://www.youtube.com/embed/wm-qroj8b18?autoplay=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				</div>
					<div id="right">
						<div class="wrap-countdown mercado-countdown" data-expire="2021/10/30 12:00:00"></div>
					</div>
			</div>

			<!-- Pre Order Product With Timer  -->
